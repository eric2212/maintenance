...
import eu.kennytv.maintenance.lib.hikari.HikariConfigMXBean;
...
implements HikariConfigMXBean {
    ...
    private static final long SOFT_TIMEOUT_FLOOR = Long.getLong("eu.kennytv.maintenance.lib.hikari.timeoutMs.floor", 250L);
    ...
    private String generatePoolName() {
        ...
        try {
            ...
            synchronized (properties) {
                String next = String.valueOf(Integer.getInteger("eu.kennytv.maintenance.lib.hikari.pool_number", 0) + 1);
                System.setProperty("eu.kennytv.maintenance.lib.hikari.pool_number", next);
