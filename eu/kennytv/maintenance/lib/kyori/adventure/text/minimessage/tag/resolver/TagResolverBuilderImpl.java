...
import eu.kennytv.maintenance.lib.kyori.adventure.text.minimessage.tag.resolver.MapTagResolver;
import eu.kennytv.maintenance.lib.kyori.adventure.text.minimessage.tag.resolver.MappableResolver;
import eu.kennytv.maintenance.lib.kyori.adventure.text.minimessage.tag.resolver.SequentialTagResolver;
...
implements TagResolver.Builder {
    ...
    @Override
    public @NotNull TagResolver.Builder resolvers(@NotNull @NotNull TagResolver @NotNull ... resolvers) {
