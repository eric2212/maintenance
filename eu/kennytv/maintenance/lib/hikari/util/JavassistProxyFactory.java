...
import eu.kennytv.maintenance.lib.hikari.pool.ProxyCallableStatement;
import eu.kennytv.maintenance.lib.hikari.pool.ProxyConnection;
import eu.kennytv.maintenance.lib.hikari.pool.ProxyDatabaseMetaData;
...
public final class JavassistProxyFactory {
    ...
    private static void modifyProxyFactory() throws NotFoundException, CannotCompileException, IOException {
        ...
        CtClass proxyCt = classPool.getCtClass("eu.kennytv.maintenance.lib.hikari.pool.ProxyFactory");
