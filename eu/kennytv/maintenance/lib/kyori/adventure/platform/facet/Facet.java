...
public interface Facet<V> {
    ...
    FakeEntity<V, P> {
        ...
        @Override
        default public void bossBarProgressChanged(@NotNull eu.kennytv.maintenance.lib.kyori.adventure.bossbar.BossBar bar, float oldProgress, float newProgress) {
            this.health(newProgress);
        }

        @Override
        default public void bossBarNameChanged(@NotNull eu.kennytv.maintenance.lib.kyori.adventure.bossbar.BossBar bar, @NotNull Component oldName, @NotNull Component newName) {
            this.name(newName);
        }
    ...
    Closeable {
        ...
        default public void bossBarInitialized(@NotNull eu.kennytv.maintenance.lib.kyori.adventure.bossbar.BossBar bar) {
    ...
    extends Facet<V> {
        public M createForSelf(V var1, @NotNull eu.kennytv.maintenance.lib.kyori.adventure.sound.Sound var2);

        public M createForEmitter(@NotNull eu.kennytv.maintenance.lib.kyori.adventure.sound.Sound var1,  @NotNull Sound.Emitter var2);
    ...
    extends Position<V, P> {
        public void playSound(@NotNull V var1, @NotNull eu.kennytv.maintenance.lib.kyori.adventure.sound.Sound var2, @NotNull P var3);
