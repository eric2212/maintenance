...
import eu.kennytv.maintenance.lib.kyori.adventure.text.minimessage.ContextImpl;
import eu.kennytv.maintenance.lib.kyori.adventure.text.minimessage.MiniMessage;
import eu.kennytv.maintenance.lib.kyori.adventure.text.minimessage.MiniMessageParser;
import eu.kennytv.maintenance.lib.kyori.adventure.text.minimessage.MiniMessageSerializer;
...
implements MiniMessage {
    ...
    MiniMessageImpl(@NotNull TagResolver resolver, boolean strict, @Nullable Consumer<String> debugOutput, @NotNull UnaryOperator<String> preProcessor, @NotNull UnaryOperator<Component> postProcessor) {
