...
implements AutoCloseable {
    ...
    private boolean useWeakThreadLocals() {
        try {
            if (System.getProperty("eu.kennytv.maintenance.lib.hikari.useWeakReferences") != null) {
                return Boolean.getBoolean("eu.kennytv.maintenance.lib.hikari.useWeakReferences");
            }
