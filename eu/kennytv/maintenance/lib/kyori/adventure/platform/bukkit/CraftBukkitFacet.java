...
import eu.kennytv.maintenance.lib.kyori.adventure.chat.ChatType;
...
import eu.kennytv.maintenance.lib.kyori.adventure.platform.bukkit.CraftBukkitAccess;
import eu.kennytv.maintenance.lib.kyori.adventure.platform.bukkit.MinecraftComponentSerializer;
            ...
            if (CLASS_CHAT_COMPONENT != null) {
                ...
                if (chatPacketConstructor == null) {
                    ...
                    if (chatPacketConstructor.type().parameterType(1).equals(Boolean.TYPE)) {
                        ...
                        chatPacketConstructor = MethodHandles.dropArguments(chatPacketConstructor, 1, Integer.class, UUID.class);
                    } else {
                        chatPacketConstructor = MethodHandles.dropArguments(chatPacketConstructor, 2, UUID.class);
                    }
                } else {
                    chatPacketConstructor = MethodHandles.dropArguments(chatPacketConstructor, 1, CLASS_MESSAGE_TYPE == null ? Object.class : CLASS_MESSAGE_TYPE, UUID.class);
                }
    ...
    implements PartialEntitySound {
        ...
        static {
            ...
            if (entitySoundPacketConstructor == null && (entitySoundPacketConstructor = MinecraftReflection.findConstructor(CraftBukkitAccess.EntitySound.CLASS_CLIENTBOUND_ENTITY_SOUND, CraftBukkitAccess.EntitySound.CLASS_SOUND_EVENT, CraftBukkitAccess.EntitySound.CLASS_SOUND_SOURCE, CLASS_NMS_ENTITY, Float.TYPE, Float.TYPE)) != null) {
                entitySoundPacketConstructor = MethodHandles.dropArguments(entitySoundPacketConstructor, 5, Long.TYPE);
            }
            ...
            if (customSoundPacketConstructor == null && (customSoundPacketConstructor = MinecraftReflection.findConstructor(CLASS_CLIENTBOUND_CUSTOM_SOUND, CraftBukkitAccess.CLASS_RESOURCE_LOCATION, CraftBukkitAccess.EntitySound.CLASS_SOUND_SOURCE, CLASS_VEC3, Float.TYPE, Float.TYPE)) != null) {
                customSoundPacketConstructor = MethodHandles.dropArguments(customSoundPacketConstructor, 5, Long.TYPE);
            }
